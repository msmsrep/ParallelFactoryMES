...
public static class MasterCsvKinds
{
    ...
    [
        ...
        [
            ...
            new("IsActive", "有効", false, "true / false。工順から紐付けている項目は無効にできない"),
        ]),
        ...
        [
            ...
            new("ControlItems", "工程管理項目の補足", false, "自由記述。指示値を持つ条件は ControlItemCodes で紐付ける"),
            new("ControlItemCodes", "工程管理項目コード", false, "セミコロン区切り。登録済みで有効な項目。作業指示に指示値を写す"),
