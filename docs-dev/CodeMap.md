...
| 作業時間記録（直接/間接） | B-30-30-02 / F-30-20-02 | `WorkTimeRecordsController.cs` `api/work-time-records` | Execution.cs: WorkTimeRecord | `ProductionRecordEntry.razor` 内 | `Tests/ExecutionTests.cs` |
